...
RUN Rscript -e 'install.packages(c("tidyverse", "glue", "bs4Dash", "plotly", "MetBrewer", "shinydashboard", "sf", "arrow", "memoise", "tmaptools", "rlang", "shinycssloaders", "sysfonts", "writexl", "geobr")'
